...
<body>  
    ...
    <section class="kotak">
        ...
        <a href="tambah_kiloan.php"><img src="layout/asset/images/tbh.png" width="30px"></a>
    </nav>
        <br><br>
<?php
...
<table>
    ...
    <?php foreach ($rows as $row) { ?>
        ...
        <tr>
            <td><?php echo $row['kiloan_id']; ?></td>
            <td><?php echo $row['jenis_kiloan']; ?></td>
            <td><?php echo $row['pel_kiloan']; ?></td>
            <td><?php echo $row['hrg_kiloan']; ?></td>
